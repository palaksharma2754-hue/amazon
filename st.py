...
""")
    ...
    st.markdown("""
<div style="
background: linear-gradient(135deg, rgba(13,27,42,0.92), rgba(27,73,101,0.88), rgba(65,105,225,0.82));
padding:30px;
border-radius:20px;
...
img = get_base64("bg10.png")   # Apni image ka naam yahan likho
